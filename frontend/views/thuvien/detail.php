...
<div class="pagewrap">
    <div class="row">
        <div class="col-md-12">
            <div class="mybreadcrumb">
                ...
                <a class="mybreadcrumb__step" href="javascript:;"><?= Yii::$app->MyComponent->myTruncate($model['name_' . Yii::$app->language], 50, " ", "..."); ?></a>
            </div>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 margin-bottom-30">
            <div><a data-fancybox="gallery" href="<?= $model['image']; ?>"><?= ImageThumb::thumbPicture(Yii::getAlias('@rootpath/' . $model['image']), 278, 200, ['source' => ['mode' => ImageThumb::THUMBNAIL_OUTBOUND, 'quality' => 80], 'img' => ['mode' => ImageThumb::THUMBNAIL_OUTBOUND, 'quality' => 80, 'attributes' => ['alt' => $model['name_' . Yii::$app->language], 'class' => 'lazy']]]); ?></a></div>
        </div>
        <?php
        if ($model['thumb']) {
            $stt = 1;
            ...
            foreach ($arrImg as $items_img) {
                ...
                ?>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 margin-bottom-30">
                    <div><a data-fancybox="gallery" href="<?= $items_img; ?>"><?= ImageThumb::thumbPicture(Yii::getAlias('@rootpath/' . $items_img), 278, 200, ['source' => ['mode' => ImageThumb::THUMBNAIL_OUTBOUND, 'quality' => 80], 'img' => ['mode' => ImageThumb::THUMBNAIL_OUTBOUND, 'quality' => 80, 'attributes' => ['alt' => $model['name_' . Yii::$app->language], 'class' => 'lazy']]]); ?></a></div>
                </div>
                <?php
                if ($stt % 4 == 0) {
                    ?>
