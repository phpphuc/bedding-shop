            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <img class="img-select img-responsive img-thumbnail" src="<?= $img; ?>" alt="Chọn hình" onclick="BrowseServer('Images:/', 'categorys-image');" />
                        <?php if ($model->image) { ?>
...
$this->registerJs(
        ...
        $('#categorys-image').bind('change', function () {
        ...
        $('#categorys-icon').bind('change', function () {
