            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <img class="img-select img-responsive img-thumbnail" src="<?= $img; ?>" alt="Chọn hình" onclick="BrowseServer('Images:/', 'postscat-image');" />
                        <?php if ($model->image) { ?>
...
$this->registerJs(
        ...
        $('#postscat-image').bind('change', function () {
