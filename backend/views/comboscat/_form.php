...
/* @var $model backend\models\Comboscat */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="comboscat-form">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <img class="img-select img-responsive img-thumbnail" src="<?= $img; ?>" alt="Chọn hình" onclick="BrowseServer('Images:/', 'comboscat-image');" />
                        <?php if ($model->image) { ?>
...
$this->registerJs(
        ...
        $('#comboscat-image').bind('change', function () {
