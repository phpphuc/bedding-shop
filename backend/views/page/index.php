            ...
            [
                ...
                'value' => function ($model) {
                    if ($model->position == 0) {
                        ...
                        return 'Header';
                    } elseif ($model->position == 2) {
                        return 'Content';
                    } elseif ($model->position == 3) {
                        return 'Footer';
                    }
                },
                'editableOptions' => [
                    ...
                    'options' =>
                    [
                        'data' => ['0' => 'Not set', '1' => 'Header', '2' => 'Content', '3' => 'Footer'],
                    ],
                ],
                'filter' => ['0' => 'Not set', '1' => 'Header', '2' => 'Content', '3' => 'Footer'],
