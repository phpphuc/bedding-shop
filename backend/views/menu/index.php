    ...
    GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => 'parentName.name_vi',
                'filter' => ArrayHelper::map(backend\models\Menu::find()->asArray()->all(), 'id', 'name_vi'),
        ...
        'toolbar' => [
            ['content' =>
                Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create', 'type' => $_GET['type']], ['title' => 'Thêm mới', 'class' => 'btn btn-default']) .
