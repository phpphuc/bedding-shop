        ...
        'columns' => [
            ...
            [
                ...
                'detail' => function ($model, $key, $index, $column) {
                    ...
                    return Yii::$app->controller->renderPartial('_orders', [
                                'dataProvider' => $dataProvider,
                    ]);
                },
            ...
            [
                ...
                'value' => function($model) {
                    return Yii::$app->formatter->asDatetime($model->created_date . Yii::$app->getTimeZone(), 'dd/MM/yyyy HH:mm:ss');
                },
            ],
            [
                'attribute' => 'status',
                ...
                'filter' => array('0' => 'Chưa xử lý', '1' => 'Đã xử lý'),
