            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <img class="img-select img-responsive img-thumbnail" src="<?= $img; ?>" alt="Chọn hình" onclick="BrowseServer('Images:/', 'camket-image');" />
                        <?php if ($model->image) { ?>
...
$this->registerJs(
    "$(document).ready(function () {
        $('#camket-image').bind('change', function () {
